...
export const HELP_CONTENT: Record<string, HelpEntry> = {
  ...
  "pages": {
    ...
    steps: [
      ...
      "Write everything in Page content, like a Word document. The toolbar covers bold text, headings, colours, lists, tables, links and images.",
      "For a richer layout, type “/” anywhere (or use the + button) to insert an image, gallery, video, callout box, columns, button, download or a coloured background section — then drag blocks to rearrange them.",
  ...
  "posts": {
    ...
    steps: [
      ...
      "Write the whole article in Content, like a Word document. The toolbar covers bold, headings, colours, lists, tables, links and images — and typing “/” (or the + button) inserts images, galleries, videos, callout boxes, columns, buttons, downloads or coloured background sections, which you can drag to rearrange.",
